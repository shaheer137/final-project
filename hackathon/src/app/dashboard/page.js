...
export default function Dashboard() {
    ...
    console.log('postUser', postUsers)
    ...
    return <div>
        ...
        <div style={{ display: 'flex' }}>
            ...
            <div style={{ flex: 3, padding: '20px', backgroundColor: 'pink' }}>
                ...
                {friends.map(item => {
                    return <div style={{ border: '1px solid black', borderRadius: '10px', margin: '10px', padding: '10px', width: '200px', display: 'flex', justifyContent: 'space-between' }} >
                        <h1> {item.fullname}</h1>
                        <FaEnvelope onClick={message} />
                    </div>
